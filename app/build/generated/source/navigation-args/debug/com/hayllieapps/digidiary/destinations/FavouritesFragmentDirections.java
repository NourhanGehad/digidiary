...
public class FavouritesFragmentDirections {
  ...
  @NonNull
  public static ActionFavouritesToDetails actionFavouritesToDetails() {
    return new ActionFavouritesToDetails();
  }
  ...
  public static class ActionFavouritesToDetails implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionFavouritesToDetails() {
    }

    @NonNull
    public ActionFavouritesToDetails setDiaryToDisplay(@Nullable Diary diaryToDisplay) {
    ...
    public int getActionId() {
      return R.id.action_favourites_to_details;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionFavouritesToDetails that = (ActionFavouritesToDetails) object;
    ...
    public String toString() {
      return "ActionFavouritesToDetails(actionId=" + getActionId() + "){"
